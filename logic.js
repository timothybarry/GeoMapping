...
//GeoJSON data will be all the quakes from the last 7 days 
...
d3.json(API_quakes, function (geoJson) {
    L.geoJSON(geoJson.features, {
        pointToLayer: function (geoJsonPoint, latlng) {
            //sets the radius of the marker based on the magnitude of the quake
...
//color function to paint the markers based on the magnitude of the quake
